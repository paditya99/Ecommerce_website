  ...
  return (
    <>
      {loading ? (
        ...
        <>
        <MetaData title={`${user.name} | EcoCart`}></MetaData>
        <Speeddial></Speeddial>
        <div class="row py-5 px-4" id="profilerow">
          <div class="col-md-5 mx-auto">
            <div class="bg-white shadow rounded overflow-hidden">
              <div class="px-4 pt-0 pb-4 cover" id="coverid">
                <div class="media align-items-end profile-head">
                  <div class="profile mr-3">
                    <img
                      src={user.avatar.url!=="avatar url" ? user.avatar.url : "/user.jpg"}
                      alt="Avatar"
              ...
              <div class="px-4 py-3" id="pxcover">
